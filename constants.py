...
PHOTOPRISM_ROOT_URL = os.environ.get('PHOTOPRISM_ROOT_URL', "https://photo.sheldonxxxx.cc")
...
PHOTOPRISM_TOKEN = os.environ.get('PHOTOPRISM_TOKEN', "f2mBUu-Nchcn0-zrSHMO-ghGV7a")


DP = bool_t(os.environ.get('DISTRIBUTED_PROCESSING', '1'))
...
NODE_NAME = os.environ.get('NODE_NAME', 'mac')
...
CAPTION_BATCH_SIZE = int(os.environ.get('CAPTION_BATCH_SIZE', 4))
